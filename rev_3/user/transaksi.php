      ...
      <div class="modal-body">
                    ...
                    <table id="datatable" class="table table-bordered" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><a href="index.php?halaman=transaksi&num=<?= $no ?>&idB=<?= $data['id']?>&brg=<?= $data['kode_brg']?>&rak=<?= $data['kode_rak'] ?>&nama=<?= $data['nama_brg'] ?>&stok=<?= $data['stok'] ?>&stat=<?= $data['status'] ?>" class="btn btn-success btn-sm">pilih</a></td>
                        </tr>
                        <?php endwhile; ?>
                        </tbody>
                    </table>
...
<form action="tambah_transaksi.php" method="POST" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
                         ...
                         <div class="row">
                           ...
                           <input type="hidden" class="form-control" value="<?= $_GET['stat'] ?>" name="status">
                           </div>
                          <div class="col-sm-4">
