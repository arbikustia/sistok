...
<main>
    <div class="container-fluid px-4 mt-3">
        <h5 class="font-monospace fw-bold">Pembayaran Belum Selesai</h5>
                    ...
                    <tbody>
                        <?php
                          $no = 1;
                              // include database
                              include 'koneksi.php';
                              $sql="SELECT * FROM pembayaran_hutang as ph LEFT JOIN vendor as v ON ph.id_vendor=v.id WHERE status='Belum Bayar';";                            
