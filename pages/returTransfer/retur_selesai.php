...
<!--                          <label class="mt-2" for="">No Transaksi</label>-->
<!--                           <div class="row">-->
<!--                          <div class="col-sm-3">-->
<!--                             <input type="text" name="cari" placeholder="Enter" class="form-control" value="" class="form-control"/>-->
<!--                              </div>-->
<!--                             <div class="col">-->
...
<div class="modal-body col-md-12">
                    ...
                    <table id="tableretur2" class="table table-bordered" cellspacing="1">
                        <thead>
                            <tr>						
                                <th>No</th> 
							    <th>No Transaksi</th>
                        ...
                        $no = 1;
                            ...
                            $sql="SELECT * FROM retur where status='selesai'";
