...
<div class="modal-body col-md-12 px-4 mt-1">
                    ...
                    <table id="datatables" class="table table-bordered" cellspacing="0">
                        ...
                        if (isset($_REQUEST['submit'])) {
                            $cari = $_POST['cari'];
                            $sql =
                                "SELECT * FROM tbl_barang WHERE kode_brg like '%" .
                                $cari .
                                "%' OR nama_brg like '%" .
                                $cari .
                                "%' order by tgl asc";
                            ...
                            $sql =
                                'SELECT * FROM tbl_barang order by waktu desc';
                            $konek = mysqli_query($kon, $sql);
                        }
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form action="hapus_brg.php" method="post">
                                  <input type="hidden" class="form-control" name="id" value="<?= $row[
                                      'id'
                                  ] ?>">
                                  <h6 class="text-center">Apakah anda yakin akan menghapus <span class="text-danger"><?= $row[
                                      'nama_brg'
                                  ] ?></span> ? <br></h6>
                     ...
                     <div class="modal fade" id="modalUbah<?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <input type="datetime-local" class="form-control" name="tgl" value="<?= $row[
                              'tgl'
                          ] ?>" name="satuan">
                          </div>
                          <div class="col">
                          ...
                          <select data-dselect-search="true" name="rak" id="dselect3" class="form-select">
                            ...
                            <option value="<?= $vall['NO_RAK'] ?>"<?php if (
    $row['kode_rak'] == $vall['NO_RAK']
) {
    echo 'selected';
} ?>><?= $vall['NO_RAK'] ?></option>
                            <?php }
                    ...
                    <div class="modal fade" id="exampleModal<?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <img src="img_brg/<?php echo $row[
                              'foto_brg'
                          ]; ?>" class="rounded" width='80%' alt="Tidak Ada Berkas">
                          <div class="card-body">
                      </div>
                    </div>
                          </div>
