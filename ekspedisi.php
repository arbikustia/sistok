...
<a class="btn btn-primary btn mt-1 mb-1"  data-bs-toggle="modal" data-bs-target="#modalTambah">Tambah Ekspedisi</a>
</div>
                    ...
                    <div class="modal fade" id="modalHapus<?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form action="action/hapus/hapus_ekspedisi.php" method="post">
                                  <input type="hidden" class="form-control" name="id" value="<?= $data['id']?>">
                                  <h6 class="text-center">Apakah anda yakin akan menghapus <span class="text-danger"><?= $data['nama_ekspedisi']?></span> ? <br></h6>
                     ...
                     <div class="modal fade" id="modalUbah<?= $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                          <form action="action/ubah/ubah_ekspedisi.php" method="post">
                          <div class="form-group">
                          <input type="hidden" name="id" value="<?= $data['id']?>" readonly>
                          </div>
                          <div class="form-group">
                          <label class="col-form-label col-form-label-sm" for="nama">Nama Ekspedisi</label>
                          <input type="text" class="form-control" value="<?= $data['nama_ekspedisi']?>" name="nama">
                          </div>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <h5 class="modal-title" id="exampleModalLabel">Tambah Ekspedisi</h5>
                          ...
                          <div class="modal-body">
                          <form action="action/tambah/tambah_ekspedisi.php" method="post">
                          <div class="form-group">
                          <label class="col-form-label col-form-label-sm" for="username">Nama Ekspedisi</label>
                          <input type="text" class="form-control" name="namaEkspedisi">
                          </div>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
